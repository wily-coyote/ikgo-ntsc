...
// Make sure these settings match those of Pass 1.
...
#define fetch_offset(offset, one_x) COMPAT_TEXTURE(Texture, vTexCoord.xy + vec2((offset) * (one_x), 0)).xyz
...
void main(void) {
	...
	signal += COMPAT_TEXTURE(Texture, vTexCoord.xy).xyz *
